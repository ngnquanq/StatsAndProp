...
\begin{frame}{Limitations (and Why They Matter)}
    \begin{enumerate}
        \item \textbf{Computational complexity: $O(n^2 \cdot T)$} (T is the avg number of iterations to converge) 
        \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item[\textcolor{customred}{Impact:}] Poor performance for $d > 4$
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                \item High-dimensional data ($d > 4$)
