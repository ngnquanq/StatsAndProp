...
\begin{frame}{References}
    \begin{enumerate}
        ...
        \item Cheng, Y. (1995). \textit{Mean shift, mode seeking, and clustering}. IEEE Transactions on Pattern Analysis and Machine Intelligence.

        \item Carreira-Perpinan, M. A. (2015). \textit{A review of mean-shift algorithms for clustering}. arXiv preprint.
    \end{enumerate}
\end{frame}
